...
// Add variable to keep track of the notes
let notes = [];
...
addEventListener('DOMContentLoaded', () => {
  ...
  addEventListener('change', function(obj) {
    ...
    inputDot.disabled = (this.value.includes('16') 
                         || this.value.includes('1'));
    
  });
  
  // Retrieve the input form is submitted
  ...
  onsubmit = (e) => {
    ...
    // Check note duration in sixteenths
...
class TonePlayer {
  ...
  play(notes, bpm) {
    ...
    // Stop and reset all the events from the tranport
    Tone.Transport.stop();
